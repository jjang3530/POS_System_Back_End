...
namespace Dima3API.Data
{
    public class DummyData
    {
        public static void Initialize(IApplicationBuilder app)
        {
            ...
            {
                var context = serviceScope.ServiceProvider.GetService<Dima3APIContext>();
                //context.Database.EnsureDeleted();
                context.Database.EnsureCreated();
                //context.Database.Migrate();

                // Look for any ailments
                if (context.Menus != null && context.Menus.Any())
        ...
        public static List<Tables> GetTables()
        {
            ...
            new Tables { TableNumber = "01", Active = "N"},
            new Tables { TableNumber = "02", Active = "Y"},
            new Tables { TableNumber = "03", Active = "Y"},
            new Tables { TableNumber = "04", Active = "N"},
            new Tables { TableNumber = "05", Active = "N"},
            new Tables { TableNumber = "06", Active = "N"},
            new Tables { TableNumber = "07", Active = "N"},
            new Tables { TableNumber = "08", Active = "N"},
            new Tables { TableNumber = "09", Active = "N"},
            new Tables { TableNumber = "10", Active = "N"},
            new Tables { TableNumber = "11", Active = "N"},
            new Tables { TableNumber = "12", Active = "N"}
            };
